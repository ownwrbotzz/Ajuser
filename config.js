...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'Xarzz' : process.env.OWNER_NAME,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Ajuser' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '6283830815715@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? 'Xarzz' : process.env.BOT_NAME,
